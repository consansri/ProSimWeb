...
data object Rv64Spec : RvSpec<ELFGenerator> {
    override val name: String = "RISC-V 64 Bit"

    override val xlen = RvSpec.XLEN.X64
    override val emuLink: EmuLink = EmuLink.RV64I
    override val instrTypes: List<AsmInstructionT> = RvInstrT.BaseT.entries + RvInstrT.MBaseT.entries + RvInstrT.I64T.entries + RvInstrT.M64T.entries + RvInstrT.PseudoT.BaseT.entries
    ...
    override fun createGenerator(): ELFGenerator = ExecELFGenerator(
        ei_class = E_IDENT.Companion.ELFCLASS64,
